...
Izkaže se, da so grafi $K_{\Delta + 1}, K_{\Delta, \Delta}$ in $C_n$ edini, za katere je meja~\eqref{eq:zgornja-meja-zf-povezan} dosežena~\cite{lu2016proof}. V~\cite{gentner2018bounds} je dokazano, da lahko mejo precej izboljšamo, če izključimo te in še kakšne grafe; znebimo se lahko zadnjega člena $\frac{2}{\Delta - 1}$.
...
\hl{TODO: spodnja meja (v povezavi z ožino).}
