...
Ker so za zelo majhne $p$ grafi močno nepovezani (imajo veliko komponent), je ničelna prisila velika. Vrednost števila hitro pade, že za $p=0.01$ je v povprečju približno~7; standardni odklon je tu največji, saj 2 povezavi več lahko pomenita, da je prisila manjša za 2. Nato število $Z(G)$ počasi spet raste, saj imajo vozlišča vse več sosedov. Standardni odklon postaja vse manjši, saj z vse večjo verjetnostjo izbiramo grafe s čedalje več povezavami in je prisila vse pogosteje maksimalna (torej $n-1$).
