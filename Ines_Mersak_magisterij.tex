...
\subsection{Neodvisnostno število in največje prirejanje}
...
Ker iz~\cite{faudree1992independent} vemo, da za neodvisnostno število kubičnega grafa $G$ brez krempljev velja $\alpha(G) \leq \frac{2}{5} n$, sledi naslednja zgornja meja za ničelno prisilo tega tipa grafa:
\begin{posledica}
    Za povezan kubičen graf $G \neq K_4$ brez krempljev velja
    \[ Z(G) \leq \frac{2}{5} n + 1. \]
\end{posledica}
