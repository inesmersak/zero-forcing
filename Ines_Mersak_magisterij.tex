...
\begin{posledica}
    ...
    \begin{enumerate}
        \item $Z(G \boxempty P_n) \leq \min \{ Z(G)n, n(G) \} \stackrel{n(G) \leq n}{=} n(G)$
        \item $Z(G \boxempty C_n) \leq \min \{ Z(G)n, 2n(G) \}$
        \item $Z(G \boxempty K_n) \leq \min \{ Z(G)n, (n-1)n(G) \}$
    \end{enumerate}
\end{posledica}
\begin{proof}
