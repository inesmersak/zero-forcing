...
\begin{algorithm}[!h]
    ...
    \begin{algorithmic}[1]
        ...
        \State $u \gets \Call{odstrani}{Q}$  \Comment{Spremembo barve zabeležimo,}
        \State $barva(u) \gets 0$  \Comment{ko element vzamemo iz vrste.}
...
Analizirajmo še prostorsko zahtevnost algoritma~\ref{alg:preveri-zf-izboljsan}.
