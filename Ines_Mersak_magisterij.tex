...
Zahtevnost izračuna števila hitrega mešanega iskanja je obravnavana v~\cite{yang2013fast}, kjer je dokazano, da je problem hitrega mešanega iskanja (ali za dan graf $G$ velja $\fms{(G)} \leq k$) $\NP$-poln. Iz izreka~\ref{izr:fms-je-zfs} torej sledi $\NP$-polnost problema \ZFOdl.

\hl{TODO: malo slabo si napisala primer in razlago pred tem, bolj poudarek, da ostale povezave ne smejo biti okužene, ko iskalec drsi.}

\hl{TODO: Brimkov: connected zero forcing še vedno NP-polno}
