...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \tikzmath{\u = 2;}
        \begin{scope}[every node/.style={circle,thick,draw}]
            \node[draw=none] (inv) at (0, \u) {};
            \node[label={$v$}] (v) at (\u, \u) {};
            \node[label=right:{$u$}] (u) at (2*\u, \u+1) {};
            \node[label=right:{$w$}] (w) at (2*\u, 1) {};
        \end{scope}

        \path[->,thick,draw]
        (inv) edge (v)
        (v) edge node[above] {$e$}  (u)
        (v) edge node[below] {$f$}  (w);
        \end{tikzpicture}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \centering
        ...
        \tikzmath{\u = 2;}
        \begin{scope}[every node/.style={circle,thick,draw}]
            \node[draw=none] (invt) at (0, \u+1) {};
            \node[draw=none] (invb) at (0, 1) {};
            \node[label={$v$}] (v) at (\u, \u) {};
            \node[label={$u$}] (u) at (2*\u, \u) {};
        \end{scope}
...
\begin{figure}[h]
    ...
    \begin{scope}[every node/.style={circle,thick,draw}]
        ...
        \node[dashed,label=below:{$v_0$}] (v0) at (\u, 0) {};
        \node[label=below:{$v_1$}] (v1) at (2*\u, 0) {};
        \node[label=below:{$u$}] (u) at (3*\u, 0) {};
    \end{scope}
