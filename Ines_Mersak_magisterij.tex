...
Primerjava vseh treh predstavitev je predstavljena v tabeli~\ref{tab:primerjava-predstavitev}.
TODO diskusija o tem, katero kdaj izbrati. 
...
O P in NP množici problemov, NP polnosti in NP težkosti.
